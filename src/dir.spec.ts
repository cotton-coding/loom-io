    ...
    describe('with generaed file', () => {
        ...
        describe('list methode', () => {
            ...
            test('list directory amount', async () => {
                const testDir1 = await testHelper.createDir('testDir');
                const testDir2 = await testHelper.createDir('testDir2/testDir3');
                const testFile1 = await testHelper.createFile('testDir23/testFile.txt');
            ...
            test('list with additional params', async () => {
                const testDir = await testHelper.createDirs(30);
                await testHelper.createDirs(2);
            ...
            test('list with additional multiple params', async () => {
                const testFile = await testHelper.createFile('testFile', {path: 'testFile.txt'});
